...
(function() {
  ...
  function injectStyle() {
    ...
    s.textContent = [
      ...
      '.hp-ef-badge{display:inline-flex;align-items:center;border-radius:9999px;padding:0.1rem 0.5rem;font-size:0.7rem;font-weight:600;background:rgba(30,45,78,0.30);color:rgba(30,45,78,0.95);margin-bottom:0.25rem;}',
      '.hp-ef-row.selected .hp-ef-badge,.hp-ef-row.current .hp-ef-badge{background:rgba(30,45,78,0.35);}',

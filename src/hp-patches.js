...
(function() {
  ...
  var ALL_FORMS = [
    ...
    {id:'form25f-restraining-order-fla',  badge:'Form 25F', title:'Restraining Order (FLA)',              tag:'Protection from harassment or threats'},
    {id:'form25g-restraining-order-clra', badge:'Form 25G', title:'Emergency Restraining Order (Without Notice)', tag:'Urgent protection — no prior notice to respondent'},
